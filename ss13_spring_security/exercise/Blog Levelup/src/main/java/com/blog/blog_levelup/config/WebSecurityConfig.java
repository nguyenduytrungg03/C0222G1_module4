package com.blog.blog_levelup.config;

import com.blog.blog_levelup.service.UserDetailsServiceImpl;
...
//                .loginPage("/login")//
                .defaultSuccessUrl("/welcome")// đăng nhập thành công -> call 1 request /userInfo
